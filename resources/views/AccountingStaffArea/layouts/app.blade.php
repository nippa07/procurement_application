...
<head>
    ...
    <!-- Favicons -->
    <title>@yield('pg-title','Accounting Staff Area | Procurement System')</title>
    @include('AccountingStaffArea.Includes.css')
    @php
...
<body>
    ...
    <!-- Sidenav -->
    @include('AccountingStaffArea.Includes.sidebar')
    <!-- Main content -->
    <div class="main-content" id="panel">
        <!-- Topnav -->
        @include('AccountingStaffArea.Includes.nav')
        <!-- Header -->
        <!-- Header -->
        ...
        <div class="container-fluid cus-div mt--6">
            ...
            <!-- Footer -->
            @include('AccountingStaffArea.Includes.footer')
        </div>
    </div>
    <!-- Logout Modal-->
    ...
    <!-- Argon Scripts -->
    <!-- Core -->
    @include('AccountingStaffArea.Includes.js')
</body>
