...
<head>
    ...
    <!-- Favicons -->
    <title>@yield('pg-title','Supplier Area | Procurement System')</title>
    @include('SupplierArea.Includes.css')
    @php
...
<body>
    ...
    <!-- Sidenav -->
    @include('SupplierArea.Includes.sidebar')
    <!-- Main content -->
    <div class="main-content" id="panel">
        <!-- Topnav -->
        @include('SupplierArea.Includes.nav')
        <!-- Header -->
        <!-- Header -->
        ...
        <div class="container-fluid cus-div mt--6">
            ...
            <!-- Footer -->
            @include('SupplierArea.Includes.footer')
        </div>
    </div>
    <!-- Logout Modal-->
    ...
    <!-- Argon Scripts -->
    <!-- Core -->
    @include('SupplierArea.Includes.js')
</body>
