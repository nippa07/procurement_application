        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 text-right">
                    <div class="">
                        <a href="{{route('siteManager.items.add')}}" class="btn btn-sm btn-neutral float-right">
                    ...
                    <td class="text-left">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                ...
                                <a class="dropdown-item" href="{{route('siteManager.items.edit', $item->id)}}">
...
<script>
    ...
    $(".delete-user").on('click', function () {
        ...
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    window.location.href = '{{ url("siteManager/items/delete") }}/' + id;
                },
                cancel: function () {
