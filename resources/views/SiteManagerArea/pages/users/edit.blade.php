        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-dark d-inline-block mb-0">Edit Supplier</h6>
        ...
        <div class="card shadow bg-secondary">
            <div class="card-body bg-transparent">
                <form class="tab-wizard wizard-circle wizard clearfix"
                    action="{{ route('siteManager.suppliers.update', $supplier->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="address_1" class="form-control" type="text" name="address_1"
                                    value="{{ $supplier->address_1 }}" required>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="address_2" class="form-control" type="text" name="address_2"
                                    value="{{ $supplier->address_2 }}" required>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
