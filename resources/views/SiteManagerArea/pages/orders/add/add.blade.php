        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-dark d-inline-block mb-0">Add Purchase Order</h6>
...
@section('js')
@include('SiteManagerArea.pages.orders.add.assets.js')
@endsection

@section('css')
@include('SiteManagerArea.pages.orders.add.assets.css')
@endsection
