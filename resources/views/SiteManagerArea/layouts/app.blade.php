...
<head>
    ...
    <!-- Favicons -->
    <title>@yield('pg-title','Site Manager Area | Procurement System')</title>
    @include('SiteManagerArea.Includes.css')
    @php
...
<body>
    ...
    <!-- Sidenav -->
    @include('SiteManagerArea.Includes.sidebar')
    <!-- Main content -->
    <div class="main-content" id="panel">
        <!-- Topnav -->
        @include('SiteManagerArea.Includes.nav')
        <!-- Header -->
        <!-- Header -->
        ...
        <div class="container-fluid cus-div mt--6">
            ...
            <!-- Footer -->
            @include('SiteManagerArea.Includes.footer')
        </div>
    </div>
    <!-- Logout Modal-->
    ...
    <!-- Argon Scripts -->
    <!-- Core -->
    @include('SiteManagerArea.Includes.js')
</body>
